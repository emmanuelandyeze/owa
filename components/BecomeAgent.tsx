...
const BecomeAgent = () => {
	return (
		<section className="w-[1240px] mx-auto px-4 py-2 md:px-0 space-y-12">
			{/* How It Works */}
			<div className="bg-[#FFF8F0] md:justify-between text-[#4D2A73] rounded-[24px] p-8 md:p-16 flex flex-col md:flex-row gap-8 items-center relative">
				<div className="w-[988px] flex flex-row justify-between gap-12 ">
					{/* Image */}
					...
					<div className="justify-end space-y-4">
						<h2 className="text-2xl text-[#4D2A73] md:text-[40px] font-[700]">
							Become an OWA agent
						</h2>
						...
						<a
							href="/agent"
							className="py-[10px] px-[16px] w-[250px] text-center text-[14px] border-[1px] border-[#4D2A73] text-[#4D2A73] cursor-pointer font-[500] rounded-[4px] transition"
						>
